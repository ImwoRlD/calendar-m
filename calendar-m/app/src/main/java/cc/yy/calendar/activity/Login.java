...
//    private Button mCancleButton;                     //注销按钮
    ...
    private TextView mPwdKeywords;                     //密码提示关键字
...
//                mCancleButton = (Button) findViewById(R.id.login_btn_cancle);
                mPwdKeywords = (TextView)findViewById(R.id.login_text_change_pwd) ;
            ...
            public void login() {                                              //登录按钮监听事件
                if (isUserNameAndPwdValid()) {
                        ...
                        if(result==1){                                             //返回1说明用户名和密码均正确
                                ...
                                Intent intent = new Intent(Login.this,MainActivity2.class) ;    //切换Login Activity至Mainactvity2 Activity
