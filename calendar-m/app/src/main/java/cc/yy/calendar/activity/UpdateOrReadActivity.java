...
//import cc.yy.calendar.Util.DeleteAsyncTask;
...
//        note = (Note) intent.getSerializableExtra("note_item");
        ...
        mComplete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mContent.getText().toString().trim().equals("")){
                    ...
                    new UpdataAsyncTask().execute();
                    Toast.makeText(UpdateOrReadActivity.this,
    ...
    //更新数据库的异步任务
    class UpdataAsyncTask extends  AsyncTask<Void,Void,Void>{
